        ...
        while ($rows = mysql_fetch_assoc($sql)) {
            ...
            <tr>
                ...
                <td>
                    ...
                    <?php if ($lang_nb2) { ?>
                        <div class="name" id="en">
                            <input type="text" name="ncata_en<?= $cl ?>" class="" value="<?= $tenbaiviet_en ?>"
                                   placeholder="Tiêu đề (<?= _lang_nb2_key ?>)">
                        </div>
                    <?php } ?>
                    <?php if ($lang_nb3) { ?>
                        <div class="name" id="en">
                            <input type="text" name="ncata_cn<?= $cl ?>" class="" value="<?= $tenbaiviet_cn ?>"
                ...
                <?php if (CHECK_key_setting("san-pham-moi")) { ?>
                    <td class="text-center">
                        <div id="cus" class="cus_menu">
                            <label><input name='opt_<?= $cl ?>' opt type='checkbox' class='minimal'
                                          value='1' <?= LAY_checked($opt, 1) ?>></label>
                        </div>
                    </td>
                <?php } ?>
                <?php if (CHECK_key_setting("san-pham-giam-gia")) { ?>
                    <td class="text-center">
                        <div id="cus" class="cus_menu">
                            <label><input name='opxx<?= $cl ?>' opt1 type='checkbox' class='minimal'
                ...
                <?php if (CHECK_key_setting("san-pham-noi-bat")) { ?>
                    <td class="text-center">
                        <div id="cus" class="cus_menu">
                            <label><input name='opx_2_<?= $cl ?>' opt2 type='checkbox' class='minimal'
                                          value='1' <?= LAY_checked($opt2, 1) ?>></label>
                        </div>
                    </td>
                <?php } ?>
                <td class="text-center">
