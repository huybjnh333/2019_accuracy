...
<div class="nav-tabs-custom">
    ...
    <div class="tab-content">
        <div class="tab-pane active" id="tab_1">
            ...
            <?php if (CHECK_key_setting("mo-ta-dich-vu-step-4")) { ?>
                <div class="form-group">
                    <label>Mô tả</label>
...
<div class="box p10">
<!--    <div class="form-group">-->
<!--        <label>Fontawesome <a data-tooltip="Chỉ thêm khi thuộc chủ đề *Chứng nhận chất lượng"> </a></label>-->
...
<!--    </div>-->
    ...
    <?php if (CHECK_key_setting("dich-vu-dowload-file")) { ?>
        <div class="form-group">
