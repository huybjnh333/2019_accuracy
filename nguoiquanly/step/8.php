    ...
    <div class="tab-content">
        <div class="tab-pane active" id="tab_1">
            ...
            <div class="form-group">
                ...
                <p style="font-size: 12px; padding: 5px 0 0; margin: 0;">Nhập Url Youtube dạng chuẩn <span
                            style="color: red">https://www.youtube.com/watch?v=eKzG6QoXFdU</span></p>
            </div>
            <?php
        ...
        <?php if ($lang_nb2) { ?>
            <div class="tab-pane" id="tab_2">
                ...
                <div class="form-group">
                    <label>URL Youtube (<?= _lang_nb2_key ?>)</label>
