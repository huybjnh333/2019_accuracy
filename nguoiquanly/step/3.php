...
<div class="nav-tabs-custom">
    ...
    <div class="tab-content">
        <div class="tab-pane active" id="tab_1">
            ...
            <?php
            $datamota = DB_fet("*", "#_module_setting", 'id=45', "", "1", "arr", 1);
            $datamota = reset($datamota);
            $array_mota = explode(',', $datamota['ten_key']);
//            var_dump($thongtin_step['id']);
                ?>
            <?php if($thongtin_step['id'] != 3){ ?>
                <div class="form-group">
                    <label>Mô tả</label>
