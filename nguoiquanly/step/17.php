    ...
    <div class="tab-content">
        ...
        <?php if ($lang_nb3) { ?>
            <div class="tab-pane" id="tab_3">
                ...
                <?php if (CHECK_key_setting("mo-ta-bai-viet-khac")) { ?>
                    <div class="form-group">
...
<div class="box p10">
    ...
    <?php if (CHECK_key_setting("lien-ket-bai-viet-khac")) { ?>
        <div class="form-group">
            <label>Liên kết <a
                        data-tooltip="Nếu không phải liên kết nội bộ thì liên kết phải có http:// hoặc https://"> </a></label>
            <input type="text" class="form-control" name="p1" id="p1" value="<?= !empty($p1) ? Show_text($p1) : "" ?>">
        </div>
    <?php } ?>
