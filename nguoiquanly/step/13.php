...
<div class="nav-tabs-custom">
    ...
    <div class="tab-content">
        <div class="tab-pane active" id="tab_1">
            <div class="form-group">
                ...
                <!---->
                <!--                <div class="form-group">-->
                <!--                <label>Cảm nhận sinh viên</label>-->
                <!--                <textarea id="noidung_vi" name="noidung_vi" rows="10"-->
                <!--                          cols="80">-->
                <? //= !empty($noidung_vi) ? SHOW_text(trim($noidung_vi)) : '' ?><!--</textarea>-->
                <!--            </div>-->
                   <div class="form-group">
            ...
            <?php if ($lang_nb2) { ?>
                <div class="tab-pane" id="tab_2">
                    ...
                    <!--               <div class="form-group">-->
                    <!--                    <label>Cảm nhận sinh viên (EN)</label>-->
                    <!--                    <textarea id="noidung_en" name="noidung_en" rows="10"-->
                    <!--                              cols="80">-->
                    <? //= !empty($noidung_en) ? SHOW_text(trim($noidung_en)) : '' ?><!--</textarea>-->
                    <!--                </div>-->
    ...
    <div class="box p10">
        ...
        <?php } ?>
        <!-- <div class="form-group">
        <label style="display: none">Seo name <a
                    data-tooltip="Đường dẫn chuẩn bao gồm các ký tự [a-zA-Z0-9-]."> </a></label>
        <input style="display: none" type="text" class="form-control" name="seo_name" id="seo_name"
               value="<?= !empty($seo_name) ? Show_text($seo_name) : "" ?>">
        <label style="display: none" class="noweight noweight-top checkbox-mini">
            <input style="display: none" class="minimal auto_get_link"
                   type="checkbox" <?= empty($id) || $id == 0 ? 'checked="checked"' : '' ?>>
            Lấy đường dẫn tự động
        </label>
    </div>-->
        <div class="form-group">
            <label>Link<a> </a></label>
            <input type="text" class="form-control" name="lienket" id="lienket"
                   value="<?= !empty($lienket) ? Show_text($lienket) : "" ?>">
