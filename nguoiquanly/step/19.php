...
<div class="nav-tabs-custom">
    ...
    <div class="tab-content">
        <div class="tab-pane active" id="tab_1">
            ...
            <?php foreach ($array_chitietduan as $k => $v) { ?>
                <div class="form-group">
                    <label><?= $v ?></label>
                    <textarea id="<?= $k ?>_vi" name="<?= $k ?>_vi" rows="10"
                              cols="80"><?= !empty(${$k . "_vi"}) ? SHOW_text(${$k . "_vi"}) : '' ?></textarea>
                </div>
        ...
        <?php if ($lang_nb2) { ?>
            <div class="tab-pane" id="tab_2">
                ...
                <?php foreach ($array_chitietduan as $k => $v) { ?>
                    <div class="form-group">
                        <label><?= $v ?> (<?= _lang_nb2_key ?>)</label>
                        <textarea id="<?= $k ?>_en" name="<?= $k ?>_en" rows="10"
                                  cols="80"><?= !empty(${$k . "_en"}) ? SHOW_text(${$k . "_en"}) : '' ?></textarea>
                    </div>
...
<div class="box p10">
    ...
    <?php if (CHECK_key_setting("hinh-banner-tin-tuc")) { ?>
        <div class="form-group">
            <label for="exampleInputFile2">Hình
                banner <?= !empty($thongtin_step['size_img']) && $thongtin_step['size_img'] != '' ? "(" . str_replace("x", "px x ", $thongtin_step['size_img']) . "px)" : '' ?></label>
    ...
    <div class="form-group">
        ...
        <div class="input-group date">
            ...
            <input name="ngaykhaigiang"
                   ...
                   id="datepicker2"
                   value='<?= (!empty($ngaykhaigiang)) ? $ngaykhaigiang : "" ?>'>
        </div>
    </div>
...
<?php
//foreach ($array_chitietduan as $k => $v) {
//    $ckeditor->replace($k . '_vi');
//    $ckeditor->replace($k . '_en');
//}
?>