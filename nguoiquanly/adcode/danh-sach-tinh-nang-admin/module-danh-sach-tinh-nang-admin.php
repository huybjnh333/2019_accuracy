                    ...
                    <div class="box">
                                        ...
                                        <td class="dvhide-row">
                                            <div class="name">
                                                ...
                                                <div class="dvhide-row">
                                                    <input type="text" name="m_action<?= $cl ?>"
                                                           value="<?= $m_action ?>" placeholder="m_action">
                                                    <input type="text" name="icon<?= $cl ?>" value="<?= $icon ?>"
                                                           placeholder="icon">
                                                    <input type="text" name="lien_ket<?= $cl ?>"
                                                           value="<?= $lien_ket ?>" placeholder="lien_ket">
                                                </div>
                                            </div>
                                        </td>
                                        <td class="text-center">
                                            <div id="cus" class="cus_menu">
                                                <label><input type="checkbox" class='minimal' name="m_xem<?= $cl ?>"
                                                              value="1" <?= (($m_xem == 1) ? "checked='checked'" : "") ?> ></label>
                                            </div>
                                        </td>
                                        <td class="text-center">
                                            <div id="cus" class="cus_menu">
                                                <label><input type="checkbox" class='minimal' name="m_them<?= $cl ?>"
                                                              value="1" <?= (($m_them == 1) ? "checked='checked'" : "") ?> ></label>
                                            </div>
                                        </td>
                                        <td class="text-center">
                                            <div id="cus" class="cus_menu">
                                                <label><input type="checkbox" class='minimal' name="m_sua<?= $cl ?>"
                                                              value="1" <?= (($m_sua == 1) ? "checked='checked'" : "") ?> ></label>
                                            </div>
                                        </td>
                                        <td class="text-center">
                                            <div id="cus" class="cus_menu">
                                                <label><input type="checkbox" class='minimal' name="m_xoa<?= $cl ?>"
                                                              value="1" <?= (($m_xoa == 1) ? "checked='checked'" : "") ?> ></label>
                                            </div>
                                        </td>
                                        <td class="text-center">
                                            <div id="cus" class="cus_menu">
                                                <label><input type="checkbox" class='minimal' name="m_other<?= $cl ?>"
                                                              value="1" <?= (($m_other == 1) ? "checked='checked'" : "") ?> ></label>
                                            </div>
                                        </td>
                                        <td class="text-center">
                                            <div id="cus" class="cus_menu">
                                        ...
                                        <tr>
                                            ...
                                            <td class="dvhide-row">
                                                ...
                                                <div class="name name_list_cap_1">
                                                    <input type="text" name="ten_vi<?= $cl ?>" value="<?= $ten_vi_2 ?>"
                                                           placeholder="ten_vi">
                                                    <div class="dvhide-row">
                                                        <input type="text" name="m_action<?= $cl ?>"
                                                               value="<?= $m_action_2 ?>" placeholder="m_action">
                                                        <input type="text" name="icon<?= $cl ?>" value="<?= $icon_2 ?>"
                                                               placeholder="icon">
                                                        <input type="text" name="lien_ket<?= $cl ?>"
                                                               value="<?= $lien_ket_2 ?>" placeholder="lien_ket">
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <div id="cus" class="cus_menu">
                                                    <label><input type="checkbox" class='minimal' name="m_xem<?= $cl ?>"
                                                                  value="1" <?= (($m_xem_2 == 1) ? "checked='checked'" : "") ?> ></label>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <div id="cus" class="cus_menu">
                                                    <label><input type="checkbox" class='minimal'
                                                                  name="m_them<?= $cl ?>"
                                                                  value="1" <?= (($m_them_2 == 1) ? "checked='checked'" : "") ?> ></label>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <div id="cus" class="cus_menu">
                                                    <label><input type="checkbox" class='minimal' name="m_sua<?= $cl ?>"
                                                                  value="1" <?= (($m_sua_2 == 1) ? "checked='checked'" : "") ?> ></label>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <div id="cus" class="cus_menu">
                                                    <label><input type="checkbox" class='minimal' name="m_xoa<?= $cl ?>"
                                                                  value="1" <?= (($m_xoa_2 == 1) ? "checked='checked'" : "") ?> ></label>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <div id="cus" class="cus_menu">
                                                    <label><input type="checkbox" class='minimal'
                                                                  name="m_other<?= $cl ?>"
                                                                  value="1" <?= (($m_other_2 == 1) ? "checked='checked'" : "") ?> ></label>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <div id="cus" class="cus_menu">
                                            ...
                                            <td class="text-center">
                                                <a href="<?= $url_page ?>&edit=<?= $ida_2 ?>"><i
                                                            class="fa fa-pencil-square-o"></i></a>
                                                <a href="<?= $url_page . '&del=ok&catalogid=' . $ida_2 ?>&token=<?= GET_token() ?>"
                                                   class="do" onclick="return confirm('Bạn thật sự muốn xóa?')"><i
                                                            class="fa fa-times"></i></a>
                                            </td>
                                        </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="dvhide-row">
                                                    ...
                                                    <div class="name name_list_cap_2">
                                                        <input type="text" name="ten_vi<?= $cl ?>"
                                                               value="<?= $ten_vi_3 ?>" placeholder="ten_vi">
                                                        <div class="dvhide-row">
                                                            <input type="text" name="m_action<?= $cl ?>"
                                                                   value="<?= $m_action_3 ?>" placeholder="m_action">
                                                            <input type="text" name="icon<?= $cl ?>"
                                                                   value="<?= $icon_3 ?>" placeholder="icon">
                                                            <input type="text" name="lien_ket<?= $cl ?>"
                                                                   value="<?= $lien_ket_3 ?>" placeholder="lien_ket">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="text-center">
                                                    <div id="cus" class="cus_menu">
                                                        <label><input type="checkbox" class='minimal'
                                                                      name="m_xem<?= $cl ?>"
                                                                      value="1" <?= (($m_xem_3 == 1) ? "checked='checked'" : "") ?> ></label>
                                                    </div>
                                                </td>
                                                <td class="text-center">
                                                    <div id="cus" class="cus_menu">
                                                        <label><input type="checkbox" class='minimal'
                                                                      name="m_them<?= $cl ?>"
                                                                      value="1" <?= (($m_them_3 == 1) ? "checked='checked'" : "") ?> ></label>
                                                    </div>
                                                </td>
                                                <td class="text-center">
                                                    <div id="cus" class="cus_menu">
                                                        <label><input type="checkbox" class='minimal'
                                                                      name="m_sua<?= $cl ?>"
                                                                      value="1" <?= (($m_sua_3 == 1) ? "checked='checked'" : "") ?> ></label>
                                                    </div>
                                                </td>
                                                <td class="text-center">
                                                    <div id="cus" class="cus_menu">
                                                        <label><input type="checkbox" class='minimal'
                                                                      name="m_xoa<?= $cl ?>"
                                                                      value="1" <?= (($m_xoa_3 == 1) ? "checked='checked'" : "") ?> ></label>
                                                    </div>
                                                </td>
                                                <td class="text-center">
                                                    <div id="cus" class="cus_menu">
                                                        <label><input type="checkbox" class='minimal'
                                                                      name="m_other<?= $cl ?>"
                                                                      value="1" <?= (($m_other_3 == 1) ? "checked='checked'" : "") ?> ></label>
                                                    </div>
                                                </td>
                                                <td class="text-center">
                                                    <div id="cus" class="cus_menu">
                                                ...
                                                <td class="text-center">
                                                    <a href="<?= $url_page ?>&edit=<?= $ida_3 ?>"><i
                                                                class="fa fa-pencil-square-o"></i></a>
                                                    <a href="<?= $url_page . '&del=ok&catalogid=' . $ida_3 ?>&token=<?= GET_token() ?>"
                                                       class="do" onclick="return confirm('Bạn thật sự muốn xóa?')"><i
                                                                class="fa fa-times"></i></a>
                                                </td>
                                            </tr>
                        ...
                        <div class="box-header">
                            <h3 class="box-title box-title-td pull-right">
                                ...
                                <a href="<?= $url_page ?>&them-moi=true" class="btn btn-primary"><i
                                            class="fa fa-plus"></i> Thêm mới</a>
                                <button type="submit" name="xoa_all_data"
                                        onclick="return confirm('Bạn chắc xóa tất cả dữ liệu trên website?')"
                                        class="btn btn-primary"><i class="fa fa-times"></i> Xóa tất cả dữ liệu
                                </button>
                            </h3>
                        </div>
                        <!--  -->
