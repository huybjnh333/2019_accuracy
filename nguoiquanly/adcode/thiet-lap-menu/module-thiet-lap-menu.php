  ...
  if(isset($_GET['them-moi']) || (isset($_GET['edit']) && is_numeric($_GET['edit']))){
    ...
    if(isset($_GET['del']))
    {
      ...
      if(mysql_num_rows($sql_se) > 0)
      {
        ...
        //
        $_SESSION['show_message_on'] = 'Xóa menu [<strong>'.$del_name.'</strong>] thành công';
        ...
        for($i=1;$i <= $_REQUEST['maxvalu'];$i++)
          {
            ...
            if(isset($_POST["xoa_gr_arr_$i"])){
              ...
              DB_que("UPDATE `$table` SET `tenbaiviet_vi`='$ncata_vi', `tenbaiviet_en`='$ncata_en', `tenbaiviet_cn`='$ncata_cn', `catasort`='$sort', `showhi`='$showhi' WHERE `id`='$idofme' LIMIT 1");
            }
          }
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <div class="name name_list_cap_1">
                                <input type="text" name="ncata_vi<?=$cl?>" class="cls_emty_name" value="<?=$tenbaiviet_vi_1?>" placeholder="Menu (vi)">
                              </div>
                              <?php if($lang_nb2){ ?>
                              <div class="name name_list_cap_1">
                                <input type="text" name="ncata_en<?=$cl?>" class="cls_emty_name" value="<?=$tenbaiviet_en_1?>" placeholder="Menu (<?=_lang_nb2_key ?>)">
                              </div>
                              <?php } ?>
                              <?php if($lang_nb3){ ?>
                              <div class="name name_list_cap_1">
                                <input type="text" name="ncata_cn<?=$cl?>" class="cls_emty_name" value="<?=$tenbaiviet_cn_1?>" placeholder="Menu (<?=_lang_nb3_key ?>)">
                              </div>
                              <?php } ?>
                            </td>
                            <td class="text-center">
                            ...
                            <tr>
                              ...
                              <td>
                                ...
                                <div class="name name_list_cap_2">
                                  <input type="text" name="ncata_vi<?=$cl?>" class="cls_emty_name" value="<?=$tenbaiviet_vi_2?>" placeholder="Menu (vi)">
                                </div>
                                <?php if($lang_nb2){ ?>
                                <div class="name name_list_cap_2">
                                  <input type="text" name="ncata_en<?=$cl?>" class="cls_emty_name" value="<?=$tenbaiviet_en_2?>" placeholder="Menu (<?=_lang_nb2_key ?>)">
                                </div>
                                <?php } ?>
                                <?php if($lang_nb3){ ?>
                                <div class="name name_list_cap_2">
                                  <input type="text" name="ncata_cn<?=$cl?>" class="cls_emty_name" value="<?=$tenbaiviet_cn_2?>" placeholder="Menu (<?=_lang_nb3_key ?>)">
                                </div>
                                <?php } ?>
                              </td>
                              <td class="text-center">
                              ...
                              <tr>
                                ...
                                <td>
                                  ...
                                  <div class="name name_list_cap_3">
                                    <input type="text" name="ncata_vi<?=$cl?>" class="cls_emty_name" value="<?=$tenbaiviet_vi_3?>" placeholder="Menu (vi)">
                                  </div>
                                  <?php if($lang_nb2){ ?>
                                  <div class="name name_list_cap_3">
                                    <input type="text" name="ncata_en<?=$cl?>" class="cls_emty_name" value="<?=$tenbaiviet_en_3?>" placeholder="Menu (<?=_lang_nb2_key ?>)">
                                  </div>
                                  <?php } ?>
                                  <?php if($lang_nb3){ ?>
                                  <div class="name name_list_cap_3">
                                    <input type="text" name="ncata_cn<?=$cl?>" class="cls_emty_name" value="<?=$tenbaiviet_cn_3?>" placeholder="Menu (<?=_lang_nb3_key ?>)">
                                  </div>
                                  <?php } ?>
                                </td>
                                <td class="text-center">
