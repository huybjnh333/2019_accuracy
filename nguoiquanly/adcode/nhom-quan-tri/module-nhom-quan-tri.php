<?php
  if(isset($_GET['them-moi']) || (isset($_GET['edit']) && is_numeric($_GET['edit']))){
      include "module-nhom-quan-tri-add.php";
  }else{
        ...
        for($i=1;$i <= $_REQUEST['maxvalu'];$i++)
          {
            ...
            if(isset($_POST["xoa_gr_arr_$i"])){
              ...
              DB_que("UPDATE `$table` SET `ten_vi`='$ten_vi', `showhi`='$showhi' ,`sort`='$sort' WHERE `id`='$idofme' LIMIT 1");
            }
          }
            ...
            <section class="col-lg-12">
                ...
                <div class="box">
                    <div class="box-header">
                      <h2 class="h2_title">
                          <i class="fa fa-pencil-square-o"></i> Nhóm quản trị
                      </h2>
                      ...
                      <table class="table table-hover table-danhsach">
                        <tbody>
                          <tr>
                            ...
                            <th>Tính năng</th>
                            <th class="w120 text-center">Phân quyền</th>
                          ...
                          <tr>
                            ...
                            <td class="text-center">
                              <a href="<?=$url_page ?>&edit=<?=$ida?>">[Phân quyền]</a>
                            </td>
                            <td class="text-center">
