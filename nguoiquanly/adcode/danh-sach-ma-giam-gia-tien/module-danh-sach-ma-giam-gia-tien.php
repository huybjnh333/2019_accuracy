<?php
  if(isset($_GET['them-moi']) || (isset($_GET['edit']) && is_numeric($_GET['edit']))){
      include "module-danh-sach-ma-giam-gia-tien-add.php";
  }else if(isset($_GET['mgg']) || (isset($_GET['mgg']) && is_numeric($_GET['mgg']))){
      include "module-danh-sach-ma-giam-gia-tien-mgg.php";
  }else{
    $table      = '#_magiamgia';
                      ...
                      <table class="table table-hover table-danhsach">
                        <tbody>
                          <tr>
                            ...
                            <th style="width: 20%" class="text-center">Mã giảm giá</th>
                          ...
                          <?php
                            ...
                            while($rows = mysql_fetch_assoc($sql)){
                              ...
                              $ma_giam_gia      = SHOW_text($rows['ma_giam_gia']);
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="name">
                                <a href="?module=danh-sach-ma-giam-gia-tien&action=danh-sach-ma-giam-gia-tien&edit=<?=$ida ?>"><?=$tenbaiviet_vi?></a>
                              </div>
<!--                              <p style="color: #8a8a8a; margin-top: 2px;">6 mã giảm giá 5 % cho đơn hàng trị giá từ 125000 ₫ </p>-->
                            </td>
                            <td class="text-center"><?=$ma_giam_gia ?></td>
                            <td class="text-left">
