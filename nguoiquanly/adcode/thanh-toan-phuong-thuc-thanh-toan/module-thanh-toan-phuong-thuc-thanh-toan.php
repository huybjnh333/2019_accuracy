                    ...
                    <div class="box-body table-responsive no-padding table-danhsach-cont">
                      <div class="dv-group-vanchuyen">
                        ...
                        <div class="dv-right">
                            <label>
                              <p>Trang thái</p>
                              <select name="check_tai_cong_ty">
                                <option value="1" <?=LAY_selected(1, @$check_tai_cong_ty) ?>>Hiển thị</option>
                                <option value="0" <?=LAY_selected(0, @$check_tai_cong_ty) ?>>Ẩn</option>
                              </select>
                            </label>
                        </div>
                        <div class="clear"></div>
                      ...
                      <div class="dv-group-vanchuyen">
                        ...
                        <div class="dv-right">
                            <label>
                              <p>Trang thái</p>
                              <select name="check_khi_nhan_hang">
                                <option value="1" <?=LAY_selected(1, @$check_khi_nhan_hang) ?>>Hiển thị</option>
                                <option value="0" <?=LAY_selected(0, @$check_khi_nhan_hang) ?>>Ẩn</option>
                              </select>
                            </label>
                        </div>
                        <div class="clear"></div>
                      ...
                      <div class="dv-group-vanchuyen">
                        ...
                        <div class="dv-right">
                            <label>
                              <p>Trang thái</p>
                              <select name="check_chuyen_khoan">
                                <option value="1" <?=LAY_selected(1, @$check_chuyen_khoan) ?>>Hiển thị</option>
                                <option value="0" <?=LAY_selected(0, @$check_chuyen_khoan) ?>>Ẩn</option>
                              </select>
                            </label>
                            <label>
                              <p>Nội dung chuyển khoản</p>
                              <textarea name="noidung_chuyenkhoan"><?=!empty($noidung_chuyenkhoan) ? $noidung_chuyenkhoan : '' ?></textarea>
                            </label>
                        </div>
                        <div class="clear"></div>
                      </div>
