    ...
    $sk.fn.extend({
        ...
        setup: function () {
            ...
            if (this.settings.fullscreen) {
                var width = $('#banner').outerWidth(true);
                var height = $('#banner').outerHeight(true);
                this.box_skitter.width(width).height(height);
                this.box_skitter.css({'position': 'relative', 'z-index': 1});
            ...
            if (this.settings.images_links.length > 1) {
                ...
                if (self.settings.preview && self.settings.dots) {
                    ...
                    self.box_skitter.find(class_info).find('.image_number').mouseenter(function () {
                        ...
                        self.box_skitter.find('.preview_slide').find('ul').animate({left: _left_ul}, {
                            duration: 200,
                            queue: false,
                            easing: 'easeOutSine'
                        });
                        self.box_skitter.find('.preview_slide').fadeTo(1, 1).animate({left: _left_preview}, {
                            duration: 200,
                            queue: false
                        });
                    });
