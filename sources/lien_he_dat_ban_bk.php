        ...
        <ul>
            <li>
                <div class="col-md row-frm">
                    ...
                    <select name="s_maphong" id="s_maphong" class="cls_data_check_form form-control" data-rong="1" data-msso="<?=$glo_lang['chon_ma_phong'] ?>">
                        <option value=""><?= $glo_lang['ma_phong'] ?></option>
                        <option value="PT01">PT01</option>
                        <option value="PT01">PT02</option>
                        <option value="PT01">PT03</option>
                        <option value="PT01">PT04</option>
                    </select>
                </div>
            </li>
            <li>
                <div class="col-md row-frm">
                    <select name="room" id="room" class="form-control">
                        <option value="" selected="">Thông số phòng ăn</option>
                        <option value="10 người/bàn">4 người/bàn</option>
                        <option value="10 người/bàn">8 người/bàn</option>
                        <option value="10 người/bàn">10 người/bàn</option>
                        <option value="10 người/bàn">20 người/bàn</option>
                        <option value="10 người/bàn">30 người/bàn</option>
                    </select>
                </div>
            </li>
            <li>
            ...
            <li>
                <div class="col-md row-frm">
                    ...
                    <select class="cls_data_check_form form-control" name="s_coso" id="s_coso" data-rong="1" data-msso="<?=$glo_lang['chon_co_so'] ?>">
