<form action="" class="formBox no_box" method="post" accept-charset="UTF-8" name="formnamecontact"
    ...
    <div class="left">
        ...
        <li class="phone">
            ...
            <input class="cls_data_check_form" data-rong="1" data-phone="1" name="s_dienthoai" id="s_dienthoai"
    ...
    <div class="right">
        ...
        <a onclick="return CHECK_send_lienhe('<?= $full_url ?>/','#formnamecontact','.cls_data_check_form')"
           ...
           class="button"><?= $glo_lang['gui'] ?> <img src="<?=$fullpath?>/images/loading2.gif" class="ajax_img_loading"></a>
    </div>
    <div class="clr"></div>
</form>