<div class="ungtuyen_popup">
    ...
    <form action="" method="post" name="dangnhap" id="dangnhap">
        ...
        <li class="bt-login">
            <a onclick="LOAD_popup_new('<?= $full_url ?>/pa-size-child/quen-mat-khau/')"
               class=" dk_dangnhap_1 quenmatkhau cur"><?= $glo_lang['quen_mat_khau'] ?></a>
            <a onclick="LOAD_popup_new('<?= $full_url ?>/pa-size-child/dang-ky/')"
               class="cur dk_dangnhap_2 "><?= $glo_lang['chua_co_tai_khoan'] ?></a>
            <div class="clr"></div>
        </li>
