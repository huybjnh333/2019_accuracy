...
<form action="" method="post" name="dangnhap" id="dangnhap">
    ...
    <div class="login_id_popup no_box">
        <div class="titBox left">
            <h3 class="tit"><?= $glo_lang['thay_doi_mat_khau'] ?></h3>
        </div>
        ...
        <div class="col-md-4 row-frm">
            <input placeholder="<?= $glo_lang['login_pass'] ?> (*)"
                   ...
                   class="form-control"
                   data-rong="1"
                   data-msso="<?= $glo_lang['login_nhap_mat_khau'] ?>">
        </div>
        <div class="col-md-4 row-frm">
            <input placeholder="<?= $glo_lang['register_repass'] ?> (*)"
                   type="password" name="repass_dk" id="repass_dk" class="form-control repass" id-khac="#pass_dk"
        ...
        <div class="box_dangnhap_popup">
            <h2><a class="cur" id="dangnhap" onClick="laymat_khau()"><?= $glo_lang['luu_thay_doi'] ?> <img
            ...
            if (send_d == 0) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (obj.error > 0) {
                            alert("<?=$glo_lang['dia_chi_ip_doi_mat_khau_khong_trung_dia_chi_ip_quen_mat_khau']  ?>");
                        } else {
