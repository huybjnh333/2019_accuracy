...
<div class="ungtuyen_popup">
    ...
    <div class="title_id"><?= $glo_lang['quen_mat_khau'] ?></div>
    <p class="text_quen_mat_kahu"><?= $glo_lang['text_quen_pass'] ?></p>
        <div class="col-md-4 row-frm">

            <input placeholder="<?= $glo_lang['email'] ?> (*)"
                   type="text" id="forget_pass" name="forget_pass" class="form-control cls_data_check_form_check_dangky"
        ...
        <div class="box_dangnhap_popup">
            <h2><a class="cur" class="btn_send_qmk" onclick="check_email('<?= $full_url ?>')"><?= $glo_lang['gui'] ?> <img
