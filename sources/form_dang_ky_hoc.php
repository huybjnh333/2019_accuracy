<form action="" class="formBox no_box" method="post" accept-charset="UTF-8" name="formthongtintuvan"
      id="formthongtintuvan">
    ...
    <input type="hidden" name="tieude_lienhe" value="<?= base64_encode($glo_lang['thong_tin_tu_van']) ?>">
    <div class="left">
        <li class="name">
            <input type="hidden" name="s_fullname_s" value="<?= base64_encode($glo_lang['ho_va_ten']) ?>">
            <input class="cls_data_check_form_dangkyhoc" data-rong="1" name="s_fullname" id="s_fullname" type="text"
        ...
        <li class="phone">
            ...
            <input class="cls_data_check_form_dangkyhoc" data-rong="1" data-phone="1" name="s_dienthoai"
                   id="s_dienthoai"
        ...
        <li class="mail">
            ...
            <input class="cls_data_check_form_dangkyhoc" data-rong="1" data-email="1" name="s_email" id="s_email"
                   type="text"
    ...
    <div class="right">
        <li class="mess">
            ...
            <textarea class="cls_data_check_form_dangkyhoc" data-rong="1" name="s_message" id="s_message" cols=""
                      rows=""
        ...
        <li class="code">
            ...
            <input class="cls_data_check_form_dangkyhoc" data-rong="1" name="mabaove" id="mabaove" type="text"
        ...
        <a onclick="RefreshFormMailContact(formthongtintuvan)" style="cursor:pointer"
           class="button"><?= $glo_lang['lam_lai'] ?></a>
        <a onclick="return CHECK_send_lienhe('<?= $full_url ?>/','#formthongtintuvan','.cls_data_check_form_dangkyhoc')"
